...
import SchoolIcon from "./graduation.png";
  ...
  return (
    <div>
      ...
      <div
        ...
        className={
          "custom-cursor absolute first-cursor" +
          (cursorType === CursorType.BIG)
            ? "big"
            : ""
        }
      ></div>
      ...
      <div
        ...
        className={
          "custom-cursor absolute second-cursor" +
          (cursorType === CursorType.BIG)
            ? "big"
            : ""
        }
...
const Cursor = ({}) => {
  ...
  return (
    <div className="Circle__Container">
      <Circles size="sm" ref={addCircleRef} delay={0} />
      <Circles size="md" ref={addCircleRef} delay={0.1} />
      <Circles size="lg" ref={addCircleRef} delay={0.22} />
    </div>
  );
};
...
export const AnimatedPhoneIllustration = () => {
  ...
  planesCard
    ...
    .add({
      ...
      opacity: 0,
      loop: true,
      easings: [0.68, 0.0, 0.33, 1.0],
      duration: 750,
      offset: 708
    })
    .add({
      targets: "#card3_bg-white",
      easings: [0.17, 0.11, 0.4, 1.26],
      duration: 666,
      offset: 625,
      scale: [0, 1]
    })
  ...
  return (
    ...
    >
      ...
      <g id="planes" transform="translate(-6.000000, -47.000000)">
        <g
          id="bg"
          transform="translate(1013.000000, 123.000000)"
          fillRule="nonzero"
        >
          <g id="board-header">
            <path
        ...
        <g
          id="cards-wrap"
          transform="translate(1013.000000, 243.000000)"
          mask="url(#mask-7)"
        >
                  ...
                  <g id="card1_icon">
                    <g id="Group" fillRule="nonzero">
                      ...
                      <g
                        ...
                        fill="#FFFFFF"
                      >
                        <path d="M81.6,30.5093168 C77.9,25.9378882 70.8,25.8385093 67,30.5093168 L45.8,56.3478261 L28.2,43.6273292 C24.6,41.0434783 19.6,41.3416149 16.3,44.3229814 L-5.68434189e-14,59.2298137 C8.5,78.2111801 27.6,91.4285714 49.8,91.4285714 C73.7,91.4285714 94,76.1242236 101.3,54.8571429 L81.6,30.5093168 Z"></path>
                        <ellipse
                          id="Oval"
                          cx="37.7"
                          cy="8.2484472"
                ...
                >
                  <g id="card2_icon">
                    ...
                    <g
                      ...
                      fillRule="nonzero"
                    >
                      <path d="M81.6,30.1118012 C77.9,25.5403727 70.8,25.4409938 67,30.1118012 L45.8,55.9503106 L28.2,43.2298137 C24.6,40.6459627 19.6,40.9440994 16.3,43.9254658 L-5.68434189e-14,58.8322981 C8.5,77.8136646 27.6,91.0310559 49.8,91.0310559 C73.7,91.0310559 94,75.7267081 101.3,54.4596273 L81.6,30.1118012 Z"></path>
                      <ellipse
                        id="Oval"
                        cx="37.7"
                        cy="7.85093168"
                ...
                >
                  <g id="card4_icon" transform="scale(0)">
                    ...
                    <g
                      ...
                      fillRule="nonzero"
                    >
                      <path d="M81.6,30.3 C77.9,25.7 70.8,25.6 67,30.3 L45.8,56.3 L28.2,43.5 C24.6,40.9 19.6,41.2 16.3,44.2 L-5.68434189e-14,59.2 C8.5,78.3 27.6,91.6 49.8,91.6 C73.7,91.6 94,76.2 101.3,54.8 L81.6,30.3 Z"></path>
