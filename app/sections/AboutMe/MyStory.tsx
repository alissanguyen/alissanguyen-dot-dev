...
const MyselfCard: React.FC = () => {
  return (
    <div className="myself-card px-8 pt-6 relative hover:scale-[1.03] duration-300 transition:ease-in lg:w-4/5 md:w-full grid overflow-visible xxs:flex xxs:flex-col">
      <div>
